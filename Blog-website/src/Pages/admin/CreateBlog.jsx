...
export function CreateBlog() {
    ...
    const [blogs, setBlogs] = useState({
        ...
        category:"",
        content:"",
        time:Timestamp.now() // firebase method
    });
    const addPost=async ()=>{
    ...
    return (
        <div className=' container mx-auto max-w-5xl py-6'>
            <div className="p-5" style={{
                ...
                {/* Four Editor  */}
                <Editor
                    apiKey='n1z2enpu8djh95y9bercwku7vw03ij04dhv520k2nieogxrd'
                    ...
                    init={{
                        plugins: 'a11ychecker advcode advlist advtable anchor autocorrect autolink autoresize autosave casechange charmap checklist code codesample directionality editimage emoticons export footnotes formatpainter fullscreen help image importcss inlinecss insertdatetime link linkchecker lists media mediaembed mentions mergetags nonbreaking pagebreak pageembed permanentpen powerpaste preview quickbars save searchreplace table tableofcontents advtemplate  tinydrive tinymcespellchecker typography visualblocks visualchars wordcount'
                    }}
                />
